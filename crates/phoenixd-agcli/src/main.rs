        ...
        .handler(|_req: &CommandRequest<'_>, _ctx: &mut ExecutionContext| {
            Box::pin(async move {
                ...
                Ok(CommandOutput::new(json!(balance)).next_actions(vec![
                    ...
                    NextAction::new("phoenixd-agcli pay --invoice <bolt11>", "Pay an invoice"),
                ]))
            })
        })
}
    ...
    Command::new("invoice", "Create a BOLT11 invoice")
        ...
        .handler(|req: &CommandRequest<'_>, _ctx: &mut ExecutionContext| {
            ...
            Box::pin(async move {
                ...
                Ok(
                    CommandOutput::new(json!(invoice)).next_actions(vec![NextAction::new(
    ...
    Command::new("pay", "Pay a BOLT11 invoice")
        ...
        .handler(|req: &CommandRequest<'_>, _ctx: &mut ExecutionContext| {
            ...
            Box::pin(async move {
                ...
                Ok(
                    CommandOutput::new(json!(result)).next_actions(vec![NextAction::new(
                        "phoenixd-agcli balance",
